...
/**
*@brief An easier way to create a quotient_filter
*@param entries the exact number of keys which will be inserted
*@param error probability of false positif
*@return an initialised quotient filter
**/
...
struct quotient_filter * quotient_recover(int file_desc);